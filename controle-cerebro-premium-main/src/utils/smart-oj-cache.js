            ...
            try {
              ...
              if (texto && texto.trim()) {
                ...
                if (textoLimpo.length > 10 && textoLimpo.length < 200) {
                  ...
                  if (deiseMatch) {
                    // Log reduzido - apenas para OJs relevantes da Deise
                    // this.logger.info(`🎯 [DEISE-DEBUG] TEXTO RELEVANTE ENCONTRADO: "${textoLimpo}" match com "${deiseMatch}"`);
                  }
                  // Logs de DEBUG desabilitados para melhorar performance
                ...
                if (contemPalavraChave && 
                  ...
                  // Logs de duplicatas desabilitados para performance
                  // else {
